...
export function SubflowBanner({ label, onBack }: SubflowBannerProps) {
  return (
    <div className="sticky top-0 z-20 mb-3 flex items-center gap-3 rounded-xl border border-slate-200 bg-white/90 px-4 py-3 text-sm font-semibold text-slate-900 shadow-sm backdrop-blur">
      <button
        type="button"
        onClick={onBack}
